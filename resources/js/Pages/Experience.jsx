    ...
    >
      <div>
        <div className={`flex flex-col items-center gap-8 ${number % 2 === 0 ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
          <div className="hidden md:flex absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 w-8 h-8 rounded-full bg-white border-2 border-red-600 items-center justify-center z-10 shadow-[0_0_15px_rgba(220,38,38,0.5)]">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="space-y-3 mt-2">
                  <div className="flex gap-3 items-start group/item">
                    <p className="text-gray-600 text-sm lg:text-base leading-relaxed transition-colors whitespace-pre-line">
      ...
      >
        {experiences.length === 0 ? (
          ...
          <div className="relative">
            <div className="hidden md:block absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-red-600 via-red-950 to-transparent opacity-30"></div>
